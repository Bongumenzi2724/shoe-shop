    ...
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 font-monsterrat text-white-400 sm:max-w-sm ">Get shoes ready for the new term at your nearest store.Find your perfect size in store. Get Rewards</p>
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
        <div className="flex flex-1 justify-start items-center gap-2 font-monsterrat cursor-pointer">
          ...
          />
          <p className="cursor-pointer">Copy Right. All Rights Reserved</p>
        </div>
